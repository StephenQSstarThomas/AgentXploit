...
class Settings:
    ...
    def _load_model_config(self):
        ...
        self.ANALYSIS_AGENT_MODEL = os.getenv("ANALYSIS_AGENT_MODEL", "openai/gpt-4o-mini")
        self.INJECTION_AGENT_MODEL = os.getenv("INJECTION_AGENT_MODEL", "openai/gpt-4o")
        self.LLM_HELPER_MODEL = os.getenv("LLM_HELPER_MODEL", "openai/gpt-4o-mini")
    ...
    def _load_injection_wrappers(self):
        ...
        self.INJECTION_WRAPPERS = {
            InjectionStrategy.TECHNICAL: os.getenv(
                "TECHNICAL_WRAPPER", 
